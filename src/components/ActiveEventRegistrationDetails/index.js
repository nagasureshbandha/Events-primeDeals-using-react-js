...
const ActiveEventRegisterationDetails = props => {
  ...
  const renderRegisterationsClosedView = () => (
    <div className="view-container">
      ...
      <h1 className="registrtions-closed-heading">
        Registrations Are Closed Now!
      </h1>

      <p className="no-active-event-description">Stay tuned. We will reopen</p>
    </div>
  )
...
export default ActiveEventRegisterationDetails
